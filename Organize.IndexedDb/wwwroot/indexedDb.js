organizeIndexedDB = {
    ...
    onUpgradeNeeded: function (event) {
        ...
        db.createdObjectStore("User", { keyPath: "id", autoIncrement: true });
        ...
        const urlItemsStore = db.createObjectStore("UrlItem", { keyPath: "id", autoIncrement: true });
        urlItemsStore.createIndex("parentId", "parentId", { unique: false });
    ...
    getAllAsync: async function (tableName) {
        return await new Promise((resolve, reject) => {
            ...
            const elements = [];
            store.openCursos().onsuccess = function (event) {
